...
const TITLES = {
  ...
  'gavril-perov': {
    ...
    description:
      'Гаврил отвечает за продуктовый дизайн в Drinkit, пришёл из моды. Разговор про город, графический язык, баланс интересов и AI без страха.',
  },
  'elena-chinakova': {
  ...
  'maxim-aksenov': {
    ...
    description:
      'Графический дизайнер с архитектурным бэкграундом – про культуру дизайна, ЛАШ и отношение к AI.',
  },
};
