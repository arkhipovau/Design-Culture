...
*Даша ведёт CGI для pont.design и 3D для Rarible. Её культура дизайна складывается из ежедневных ценностей: честный диалог с клиентом, логика важнее красивой картинки, смелость в безопасном эксперименте. В CGI она ищет метафору, которая сокращает расстояние между продуктом и человеком.*
