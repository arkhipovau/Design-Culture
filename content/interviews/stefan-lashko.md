...
**DF:** В ваших проектах — от Ректора до самых последних — всё очень выразительно, очень точно. За этим, кажется, скрывается не только желание нарушать правила, но и знание этих правил.
...
1. **Имена и факты, требующие сверки.**
   ...
   — Проект «Ректор» — упомянут DF («начиная с какого-нибудь Ректора, наверное, с которого мы с вами познакомились»). Со слуха — «Ректор» / «Rektor» / другое; проверить.
...
7. **Композиционная развилка.** В источнике у Стефана нет ни «истории объекта» (как у Бреуса с F61 и Полухиным), ни персональной маркерной анекдоты (как у Барабоновой с Лобней и тату). Самое «объектное» — это упоминание проекта Ректор. Если для defindings важно якорить материал на конкретные кейсы, имеет смысл попросить героя (или к публикации) три-четыре проекта-иллюстрации с короткими подписями: что и для кого, чтобы текст лёг на работы.
